...
religions_todo = [
	...
	"zainuddian",
	"yedidyhan",
	"blood_tainted_pantheon",
	"father_protector_pantheon",
	"dragkhan_pantheon",
	"artheous_pantheon",
	"celtican_pantheon",
	"shamanist_beliefs",
	"mother_earth_pantheon",
	"orcish_ancestral_faith",
	"the_old_father_stone",
	"transcendence_enlighten",
	"vetalian_pantheon",
	"seekers_beliefs",
	"ancestral_beliefs",
