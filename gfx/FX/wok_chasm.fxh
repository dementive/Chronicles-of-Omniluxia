...
PixelShader
{
	...
	[[
		...
		static const float3 CHASM_BOTTOM_COLOR = float3(0.015, 0.00, 0.00);

		static const float2 CHASM_SYMMETRY_CENTER = float2(2507.0, 2524.0);
		...
		static const float CHASM_WALL_NORMALS_SAMPLE_DISTANCE = 0.5;
			...
			static const float CHASM_MAX_FAKE_DEPTH   = 4.0;
