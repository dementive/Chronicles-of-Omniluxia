...
PixelShader
{
	...
	[[
		...
		void CalculateDetails( float2 WorldSpacePosXZ, out float4 DetailDiffuse, out float3 DetailNormal, out float4 DetailMaterial )
		{
			...
			DetailDiffuse = DiffuseTexture0 * BlendFactors.x + 
							DiffuseTexture1 * BlendFactors.y + 
							DiffuseTexture2 * BlendFactors.z + 
							DiffuseTexture3 * BlendFactors.w;
